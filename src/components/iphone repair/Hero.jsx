...
const iphoneModels = [
  ...
  { title: "iPhone 17 Pro", image: "/img31.png" },
  { title: "iPhone 17", image: "/img30.png" },
  { title: "iPhone Air", image: "/img29.png" },
  { title: "iPhone 16 Pro Max", image: "/img28.png" },
  { title: "iPhone 16 Pro", image: "/img27.png" },
  { title: "iPhone 16", image: "/img26.png" },
  { title: "iPhone 15 Pro Max", image: "/img25.png" },
  { title: "iPhone 15 Pro", image: "/img25.png" },
  { title: "iPhone 15", image: "/img24.png" },
  { title: "iPhone 14 Pro Max", image: "/img4.png" },
  { title: "iPhone 14 Pro", image: "/img4.png" },
  { title: "iPhone 14 Plus", image: "/img4.png" },
  ...
  { title: "iPhone 11", image: "/iphone11.png" },
  { title: "iPhone XS Max", image: "/img11.png" },
  { title: "iPhone XS", image: "/img11.png" },
  { title: "iPhone XR", image: "/img23.png" },
  { title: "iPhone X", image: "/img11.png" },
  { title: "iPhone SE", image: "/img12.png" },
  { title: "iPhone SE (2nd Generation)", image: "/img21.png" },
  { title: "iPhone SE (1st Generation)", image: "/img12.png" },
  { title: "iPhone 8 Plus", image: "/img21.png" },
  { title: "iPhone 8", image: "/img20.png" },
  { title: "iPhone 7 Plus", image: "/img19.png" },
  { title: "iPhone 7", image: "/img18.png" },
  { title: "iPhone 6S Plus", image: "/img17.png" },
  { title: "iPhone 6S", image: "/img17.png" },
  { title: "iPhone 6 Plus", image: "/img15.png" },
    ...
    <div className="bg-white text-[#171a23]">
      ...
      >
        ...
        <div className="relative mx-auto max-w-[1120px]">
          <h1 className="text-[34px] font-bold leading-tight sm:text-[40px] lg:text-[46px]">
            iPhone Repairs
          </h1>
      ...
      <section className="rmg-model-section mx-auto max-w-[1720px] px-6 py-14 sm:px-10 lg:px-20 lg:py-16">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <h2 className="text-[28px] font-bold leading-tight sm:text-[36px] lg:text-[40px]">
      ...
      <section className="bg-[#f4f4f4]">
        <div className="mx-auto grid max-w-[1720px] items-center gap-12 px-6 py-14 sm:px-10 lg:grid-cols-2 lg:px-20 lg:py-16">
          ...
          />
          <div>
            <h2 className="text-[30px] font-bold leading-tight sm:text-[38px] lg:text-[42px]">
